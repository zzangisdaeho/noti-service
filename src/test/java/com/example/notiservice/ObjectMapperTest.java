...
public class ObjectMapperTest {
    ...
    void mapperTest() throws JsonProcessingException {
        EmailNotification emailNotification1 = new EmailNotification("transAction1", "email","sender@naver.com", "reciver1@naver.com", new EmailSystemProfile("emailCredential"));
        EmailNotification emailNotification2 = new EmailNotification("transAction1", "email","sender@naver.com", "reciver2@naver.com", new EmailSystemProfile("emailCredential"));

        SMSNotification smsNotification = new SMSNotification("transAction1", "sms", "010-1111-1111", "010-2222-2222", new SMSSystemProfile("smsCredential"));
        SocialNetworkNotification socialNetworkNotification = new SocialNetworkNotification("transAction1", "sns", "smsSenderId1", "smsReceiverId1", new SocialNetworkSystemProfile("snsCredential"));
